...
class EditarListaDeCompras extends StatelessWidget {
  EditarListaDeCompras({Key? key}) : super(key: key);
  AppController controller = Get.find();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Cubo Connect - Editar lista"),
      ),
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            BotaoPadrao(
              text: "Salvar lista",
              onPressed: () => controller.salvarListaEditada(context),
            ),
          ],
        ),
      ),
